...
Hệ thống tài liệu chuyên sâu, phân tích bản chất kiến trúc (_Why & Trade-offs_), bộ câu hỏi phỏng vấn thực chiến và sân tập sandbox dành cho kỹ sư **Middle / Senior / Lead Next.js & Frontend Engineer**.
...
- 📑 _Cheat-Sheet 01:_ [reference/01-rendering-and-rsc-cheatsheet.html](reference/01-rendering-and-rsc-cheatsheet.html)
...
- 📑 _Cheat-Sheet 02:_ [reference/02-routing-caching-actions-cheatsheet.html](reference/02-routing-caching-actions-cheatsheet.html)
...
- 📑 _Cheat-Sheet 03:_ [reference/03-performance-security-cheatsheet.html](reference/03-performance-security-cheatsheet.html)
...
- 📑 _Cheat-Sheet 04:_ [reference/04-system-design-mock-interview-cheatsheet.html](reference/04-system-design-mock-interview-cheatsheet.html)
